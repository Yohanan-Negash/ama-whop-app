          ...
          <Tabs defaultValue="pending">
              ...
              <ScrollArea className="h-[60vh] min-h-[320px] rounded-md border-none">
                <Card className="border-0 shadow-sm bg-card rounded-md p-1 sm:p-2 w-full">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base sm:text-lg text-foreground text-center">Pending Anonymous Questions</CardTitle>
                    <div className="text-center text-xs sm:text-sm text-muted-foreground">Review and approve or delete questions submitted by users. Only approved questions will be visible to the public.</div>
                  </CardHeader>
            ...
            <TabsContent value="approved">
              <ScrollArea className="h-[60vh] min-h-[320px] rounded-md border-none">
                <Card className="border-0 shadow-sm bg-card rounded-md p-1 sm:p-2 w-full">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base sm:text-lg text-foreground text-center">Approved Anonymous Questions</CardTitle>
                    <div className="text-center text-xs sm:text-sm text-muted-foreground">These questions have been approved and can be visible to your community by creating a forum.</div>
                  </CardHeader>
                  <CardContent className="p-0">
                    <ApprovedQuestions />
                  </CardContent>
